...
export const equipment = [
  {
    ...
    specs: [
      { k: 'Типы агрегатов', v: 'Консольные (ОН2), двухопорные межподшипниковые (ВВ1, ВВ2, ВВ3, ВВ5), вертикальные полупогружные (VS1, VS6), центробежные, химические с магнитной муфтой' },
      ...
      { k: 'Материалы', v: 'Углеродистые, кремнемарганцовистые, хромомолибденовые и коррозионностойкие высоколегированные стали (12Х18Н10Т, 10Х17Н13М2Т)' },
      { k: 'Герметизация', v: 'Двойные и одинарные торцевые уплотнения по ГОСТ 32600, обвязка по российским аналогам планов API' },
    ],
  },
  {
    ...
    specs: [
      { k: 'Условное давление (Ру)', v: 'От 0,6 до 16,0 МПа (в специальном исполнении для газов высокого давления — до 32,0 МПа)' },
      { k: 'Вакуумные режимы', v: 'С остаточным давлением не ниже 665 Па (5 мм рт. ст.)' },
      { k: 'Теплообменные трубы', v: 'Биметаллические накатные с алюминиевым оребрением (коэффициенты 7,0 / 9,0 / 14,6 / 20,0); длина пучка 1,5–12 м' },
      { k: 'Вентиляторы', v: 'Колёса Ø 0,8–7,0 м; электродвигатели привода 3–75 кВт (до 160 кВт для тяжёлых блоков)' },
      { k: 'Климатическое исполнение', v: 'У1 и УХЛ1 по ГОСТ 15150 (работа до −60 °С); автоматические жалюзи и рециркуляция воздуха во избежание застывания продуктов' },
    ],
  },
  {
    ...
    specs: [
      ...
      { k: 'Габариты и масса', v: 'Высота 1,97–4,46 м; масса 125–3240 кг' },
      { k: 'Материалы', v: 'Легированная сталь (стойкость до −50 °C), композитные элементы вентилятора' },
    ],
  },
  {
    ...
    specs: [
      { k: 'Кожухотрубные', v: 'Диаметры кожуха 159–2500 мм; площадь поверхности теплообмена — до 4000 м² в одном корпусе' },
      { k: 'Пластинчатые', v: 'Рабочее давление до 4,0 МПа (разборные), до 10,0 МПа (цельносварные «пластина в кожухе»); температуры от −100 до +400 °C' },
      { k: 'Спиральные', v: 'Ширина каналов от 5 до 30 мм' },
      { k: 'Материалы', v: 'Сталь 20, 09Г2С, 12Х18Н10Т, 10Х17Н13М2Т, сплавы титана' },
    ],
  },
  {
    ...
    specs: [
      ...
      { k: 'Материалы', v: 'Конструкционные стали (09Г2С, сталь 20), хромомолибденовые для высоких температур (12ХМ, 15Х5М), двухслойные плакированные с коррозионностойким слоем (08Х13, 08Х18Н10Т)' },
    ],
  },
  {
    ...
    specs: [
      { k: 'Тепловая мощность БМК', v: 'От 0,5 до 50 МВт; паровые котельные (давление пара до 2,5 МПа, температура до 250 °C) и водогрейные системы (графики 95/70, 115/70, 150/70 °C)' },
      { k: 'Тепловая нагрузка БТП', v: 'От 0,1 до 15 Гкал/ч' },
      { k: 'Топливо', v: 'Природный газ, попутный нефтяной газ (ПНГ), дизельное топливо, мазут; КПД установок — не менее 92–95 %' },
      { k: 'Взрывозащита', v: 'Электрооборудование, датчики КИП и исполнительные механизмы сертифицированы по ТР ТС 012/2011; исполнение Exd («взрывонепроницаемая оболочка») или Exi («искробезопасная цепь»)' },
